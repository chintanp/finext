...
// var deltan = {};   // For storing the results
...
io.on('connection', function(socket) {
	...
	socket.on('BeginSolve', function(uid) {
		...
		request.get(FIREBASE_URL + '/models/' + uid.id + '.json', function optionalCallback (err, httpResponse, body) {
			...
			resultRef.set({displacements : deltan});

			console.log("Deltan: " + deltan);
			console.log("Typeof deltan: " + typeof(deltan));

			//TODO Modularization to support other type of structures and other analysis types
			// TODO enable option to checek the results against staad-pro
