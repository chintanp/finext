/*! @license Firebase v1.1.0 - License: https://www.firebase.com/terms/terms-of-service.html */ var k,aa=this;function m(a){return void 0!==a}function ba(){}function ca(a){a.gb=function(){return a.Id?a.Id:a.Id=new a}}
...
function Ja(a,b,c,d){if(!d||m(c)){if(Ha(c))throw Error(y(a,b,d)+"is "+c.toString()+", but must be a valid Firebase priority (a string, finite number, or null).");if(!(null===c||ga(c)||p(c)||ia(c)&&A(c,".sv")))throw Error(y(a,b,d)+"must be a valid Firebase priority (a string, finite number, or null).");}}
...
k.M=function(a,b,c,d,e){return new ib(null!=a?a:this.key,null!=b?b:this.value,null!=c?c:this.color,null!=d?d:this.left,null!=e?e:this.right)};k.count=function(){return this.left.count()+1+this.right.count()};k.f=function(){return!1};k.Ca=function(a){return this.left.Ca(a)||a(this.key,this.value)||this.right.Ca(a)};k.Ua=function(a){return this.right.Ua(a)||a(this.key,this.value)||this.left.Ua(a)};function jb(a){return a.left.f()?a:jb(a.left)}k.Jb=function(){return jb(this).key};
...
Ab.prototype.update=function(a,b){m(b)||(b=a.length);for(var c=b-this.qa,d=0,e=this.Oc,f=this.ib;d<b;){if(0==f)for(;d<=c;)Bb(this,a,d),d+=this.qa;if(p(a))for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.qa){Bb(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.qa){Bb(this,e);f=0;break}}this.ib=f;this.Hc+=b};function Cb(){return Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^la()).toString(36)};var L=Array.prototype,Db=L.indexOf?function(a,b,c){return L.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(p(a))return p(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},Eb=L.forEach?function(a,b,c){L.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=p(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},Fb=L.filter?function(a,b,c){return L.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],f=0,g=p(a)?
a.split(""):a,h=0;h<d;h++)if(h in g){var l=g[h];b.call(c,l,h,a)&&(e[f++]=l)}return e},Gb=L.map?function(a,b,c){return L.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=p(a)?a.split(""):a,g=0;g<d;g++)g in f&&(e[g]=b.call(c,f[g],g,a));return e},Hb=L.reduce?function(a,b,c,d){d&&(b=r(b,d));return L.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;Eb(a,function(c,g){e=b.call(d,e,c,g,a)});return e},Ib=L.every?function(a,b,c){return L.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=
p(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&!b.call(c,e[f],f,a))return!1;return!0};function Jb(a,b){var c;a:{c=a.length;for(var d=p(a)?a.split(""):a,e=0;e<c;e++)if(e in d&&b.call(void 0,d[e],e,a)){c=e;break a}c=-1}return 0>c?null:p(a)?a.charAt(c):a[c]}function Kb(a,b){a.sort(b||Lb)}function Lb(a,b){return a>b?1:a<b?-1:0};var Mb;a:{var Nb=aa.navigator;if(Nb){var Ob=Nb.userAgent;if(Ob){Mb=Ob;break a}}Mb=""}function Pb(a){return-1!=Mb.indexOf(a)};var Qb=Pb("Opera")||Pb("OPR"),Rb=Pb("Trident")||Pb("MSIE"),Sb=Pb("Gecko")&&-1==Mb.toLowerCase().indexOf("webkit")&&!(Pb("Trident")||Pb("MSIE")),Tb=-1!=Mb.toLowerCase().indexOf("webkit");(function(){var a="",b;if(Qb&&aa.opera)return a=aa.opera.version,ha(a)?a():a;Sb?b=/rv\:([^\);]+)(\)|;)/:Rb?b=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:Tb&&(b=/WebKit\/(\S+)/);b&&(a=(a=b.exec(Mb))?a[1]:"");return Rb&&(b=(b=aa.document)?b.documentMode:void 0,b>parseFloat(a))?String(b):a})();var Ub=null,Vb=null;
function Wb(a,b){if(!fa(a))throw Error("encodeByteArray takes an array as a parameter");if(!Ub){Ub={};Vb={};for(var c=0;65>c;c++)Ub[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c),Vb[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c)}for(var c=b?Vb:Ub,d=[],e=0;e<a.length;e+=3){var f=a[e],g=e+1<a.length,h=g?a[e+1]:0,l=e+2<a.length,n=l?a[e+2]:0,q=f>>2,f=(f&3)<<4|h>>4,h=(h&15)<<2|n>>6,n=n&63;l||(n=64,g||(h=64));d.push(c[q],c[f],c[h],c[n])}return d.join("")}
...
function Yd(a,b,c,d){a.T?Zd(a,"o",b,c,d):a.Kb.push({mb:b,action:"o",data:c,G:d})}function $d(a,b,c,d){a.T?Zd(a,"om",b,c,d):a.Kb.push({mb:b,action:"om",data:c,G:d})}k.hd=function(a,b){this.T?Zd(this,"oc",a,null,b):this.Kb.push({mb:a,action:"oc",data:null,G:b})};function Zd(a,b,c,d,e){c={p:c,d:d};a.e("onDisconnect "+b,c);a.Fa(b,c,function(a){e&&setTimeout(function(){e(a.s,a.d)},Math.floor(0))})}k.put=function(a,b,c,d){ae(this,"p",a,b,c,d)};function be(a,b,c,d){ae(a,"m",b,c,d,void 0)}
function ae(a,b,c,d,e,f){c={p:c,d:d};m(f)&&(c.h=f);a.V.push({action:b,Td:c,G:e});a.Nb++;b=a.V.length-1;a.T&&ce(a,b)}function ce(a,b){var c=a.V[b].action,d=a.V[b].Td,e=a.V[b].G;a.V[b].Le=a.T;a.Fa(c,d,function(d){a.e(c+" response",d);delete a.V[b];a.Nb--;0===a.Nb&&(a.V=[]);e&&e(d.s,d.d)})}
...
fc("Unrecognized action received from server: "+u(b)+"\nAre you using the latest client?"))}};k.Lb=function(a){this.e("connection ready");this.T=!0;this.Gb=(new Date).getTime();this.kd({serverTimeOffset:a-(new Date).getTime()});Vd(this);for(var b in this.ia)for(var c in this.ia[b])a=this.ia[b][c],Td(this,b,c,a.ob,a.G);for(b=0;b<this.V.length;b++)this.V[b]&&ce(this,b);for(;this.Kb.length;)b=this.Kb.shift(),Zd(this,b.action,b.mb,b.data,b.G);this.qc(!0)};
function Qd(a,b){v(!a.la,"Scheduling a connect when we're already connected/ing?");a.eb&&clearTimeout(a.eb);a.eb=setTimeout(function(){a.eb=null;ee(a)},Math.floor(b))}k.Ie=function(a){a&&!this.vb&&this.ua===this.lc&&(this.e("Window became visible.  Reducing delay."),this.ua=1E3,this.la||Qd(this,0));this.vb=a};
...
k.Pd=function(){this.e("data client disconnected");this.T=!1;this.la=null;for(var a=0;a<this.V.length;a++){var b=this.V[a];b&&"h"in b.Td&&b.Le&&(b.G&&b.G("disconnect"),delete this.V[a],this.Nb--)}0===this.Nb&&(this.V=[]);if(this.Wa)this.vb?this.Gb&&(3E4<(new Date).getTime()-this.Gb&&(this.ua=1E3),this.Gb=null):(this.e("Window isn't visible.  Delaying reconnect."),this.ua=this.lc,this.dd=(new Date).getTime()),a=Math.max(0,this.ua-((new Date).getTime()-this.dd)),a*=Math.random(),this.e("Trying to reconnect in "+
a+"ms"),Qd(this,a),this.ua=Math.min(this.lc,1.3*this.ua);else for(var c in this.Ub)delete this.Ub[c];this.qc(!1)};function ee(a){if(a.Wa){a.e("Making a connection attempt");a.dd=(new Date).getTime();a.Gb=null;var b=r(a.rc,a),c=r(a.Lb,a),d=r(a.Pd,a),e=a.id+":"+Rd++;a.la=new xd(e,a.D,b,c,d,function(b){M(b+" ("+a.D.toString()+")");a.Wa=!1})}}k.Ma=function(){this.Wa=!1;this.la?this.la.close():(this.eb&&(clearTimeout(this.eb),this.eb=null),this.T&&this.Pd())};
k.rb=function(){this.Wa=!0;this.ua=1E3;this.T||Qd(this,0)};function de(a,b,c){c=c?Gb(c,function(a){return Sa(a)}).join("$"):"{}";(a=Ud(a,b,c))&&a.G&&a.G("permission_denied")}function Ud(a,b,c){b=(new H(b)).toString();c||(c="{}");var d=a.ia[b][c];delete a.ia[b][c];return d};function fe(){this.o=this.H=null}fe.prototype.pb=function(a,b){if(a.f())this.H=b,this.o=null;else if(null!==this.H)this.H=this.H.Aa(a,b);else{null==this.o&&(this.o=new fd);var c=D(a);this.o.contains(c)||this.o.add(c,new fe);c=this.o.get(c);a=Ta(a);c.pb(a,b)}};
function ge(a,b){if(b.f())return a.H=null,a.o=null,!0;if(null!==a.H){if(a.H.Q())return!1;var c=a.H;a.H=null;c.B(function(b,c){a.pb(new H(b),c)});return ge(a,b)}return null!==a.o?(c=D(b),b=Ta(b),a.o.contains(c)&&ge(a.o.get(c),b)&&a.o.remove(c),a.o.f()?(a.o=null,!0):!1):!0}function he(a,b,c){null!==a.H?c(b,a.H):a.B(function(a,e){var f=new H(b.toString()+"/"+a);he(e,f,c)})}fe.prototype.B=function(a){null!==this.o&&gd(this.o,function(b,c){a(b,c)})};function ie(){this.aa=P}function T(a,b){return a.aa.N(b)}function U(a,b,c){a.aa=a.aa.Aa(b,c)}ie.prototype.toString=function(){return this.aa.toString()};function je(){this.va=new ie;this.O=new ie;this.pa=new ie;this.Pb=new Xa}function ke(a,b,c){U(a.va,b,c);return le(a,b)}function le(a,b){for(var c=T(a.va,b),d=T(a.O,b),e=I(a.Pb,b),f=!1,g=e;null!==g;){if(null!==g.k()){f=!0;break}g=g.parent()}if(f)return!1;c=me(c,d,e);return c!==d?(U(a.O,b,c),!0):!1}function me(a,b,c){if(c.f())return a;if(null!==c.k())return b;a=a||P;c.B(function(d){d=d.name();var e=a.P(d),f=b.P(d),g=I(c,d),e=me(e,f,g);a=a.K(d,e)});return a}
je.prototype.set=function(a,b){var c=this,d=[];Eb(b,function(a){var b=a.path;a=a.ta;var g=Xb();Ya(I(c.Pb,b),g);U(c.O,b,a);d.push({path:b,Re:g})});return d};function ne(a,b){Eb(b,function(b){var d=b.Re;b=I(a.Pb,b.path);var e=b.k();v(null!==e,"pendingPut should not be null.");e===d&&Ya(b,null)})};function oe(a,b){return a&&"object"===typeof a?(v(".sv"in a,"Unexpected leaf node or priority contents"),b[a[".sv"]]):a}function pe(a,b){var c=new fe;he(a,new H(""),function(a,e){c.pb(a,qe(e,b))});return c}function qe(a,b){var c=oe(a.m(),b),d;if(a.Q()){var e=oe(a.k(),b);return e!==a.k()||c!==a.m()?new vc(e,c):a}d=a;c!==a.m()&&(d=d.Ha(c));a.B(function(a,c){var e=qe(c,b);e!==c&&(d=d.K(a,e))});return d};var re="auth.firebase.com";function se(a,b,c){this.ec=a||{};this.Ic=b||{};this.sb=c||{};this.ec.remember||(this.ec.remember="default")}var te=["remember","redirectTo"];function ue(a){var b={},c={};za(a||{},function(a,e){0<=Db(te,a)?b[a]=e:c[a]=e});return new se(b,{},c)};var ve={NETWORK_ERROR:"Unable to contact the Firebase server.",SERVER_ERROR:"An unknown server error occurred.",TRANSPORT_UNAVAILABLE:"There are no login transports available for the requested method.",REQUEST_INTERRUPTED:"The browser redirected the page before the login request could complete.",USER_CANCELLED:"The user cancelled authentication."};function V(a){var b=Error(B(ve,a),a);b.code=a;return b};function we(){var a=window.opener.frames,b;for(b=a.length-1;0<=b;b--)try{if(a[b].location.protocol===window.location.protocol&&a[b].location.host===window.location.host&&"__winchan_relay_frame"===a[b].name)return a[b]}catch(c){}return null}function xe(a,b,c){a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener&&a.addEventListener(b,c,!1)}function ye(a,b,c){a.detachEvent?a.detachEvent("on"+b,c):a.removeEventListener&&a.removeEventListener(b,c,!1)}
function ze(a){/^https?:\/\//.test(a)||(a=window.location.href);var b=/^(https?:\/\/[\-_a-zA-Z\.0-9:]+)/.exec(a);return b?b[1]:a}function Ae(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=B(a,c);if(ea(d))for(var e=0;e<d.length;e++)b.push(encodeURIComponent(c)+"="+encodeURIComponent(d[e]));else b.push(encodeURIComponent(c)+"="+encodeURIComponent(B(a,c)))}return b.join("&")}function Be(){var a=hc(re);return a.scheme+"://"+a.host+"/v2"};function Ce(){var a=navigator.userAgent;if("Microsoft Internet Explorer"===navigator.appName){if((a=a.match(/MSIE ([0-9]{1,}[\.0-9]{0,})/))&&1<a.length)return 8<=parseFloat(a[1])}else if(-1<a.indexOf("Trident")&&(a=a.match(/rv:([0-9]{2,2}[\.0-9]{0,})/))&&1<a.length)return 8<=parseFloat(a[1]);return!1};function De(a){a=a||{};a.method||(a.method="GET");a.headers||(a.headers={});a.headers.content_type||(a.headers.content_type="application/json");a.headers.content_type=a.headers.content_type.toLowerCase();this.options=a}
De.prototype.open=function(a,b,c){function d(){c&&(c(V("REQUEST_INTERRUPTED")),c=null)}var e=new XMLHttpRequest,f=this.options.method.toUpperCase(),g;xe(window,"beforeunload",d);e.onreadystatechange=function(){if(c&&4===e.readyState){var a;if(200<=e.status&&300>e.status){try{a=ua(e.responseText)}catch(b){}c(null,a)}else 500<=e.status&&600>e.status?c(V("SERVER_ERROR")):c(V("NETWORK_ERROR"));c=null;ye(window,"beforeunload",d)}};if("GET"===f)a+=(/\?/.test(a)?"":"?")+Ae(b),g=null;else{var h=this.options.headers.content_type;
"application/json"===h&&(g=u(b));"application/x-www-form-urlencoded"===h&&(g=Ae(b))}e.open(f,a,!0);a={"X-Requested-With":"XMLHttpRequest",Accept:"application/json;text/plain"};Pc(a,this.options.headers);for(var l in a)e.setRequestHeader(l,a[l]);e.send(g)};De.isAvailable=function(){return!1};De.prototype.yb=function(){return"json"};function Ee(a){a=a||{};this.Vb=Cb()+Cb()+Cb();this.Qd=a||{}}
Ee.prototype.open=function(a,b,c){function d(){c&&(c(V("USER_CANCELLED")),c=null)}var e=this,f=hc(re),g;b.requestId=this.Vb;b.redirectTo=f.scheme+"://"+f.host+"/blank/page.html";a+=/\?/.test(a)?"":"?";a+=Ae(b);(g=window.open(a,"_blank","location=no"))&&ha(g.addEventListener)?(g.addEventListener("loadstart",function(a){a&&a.url&&(a=hc(a.url),a.host===re&&"/blank/page.html"===a.mb&&(g.removeEventListener("exit",d),g.close(),a=new se(null,null,{requestId:e.Vb}),e.Qd.requestWithCredential("/auth/session",
a,c),c=null))}),g.addEventListener("exit",d)):c(V("TRANSPORT_UNAVAILABLE"))};ma("fb.login.transports.CordovaInAppBrowser.prototype.open",Ee.prototype.open);Ee.isAvailable=function(){return!1};Ee.prototype.yb=function(){return"redirect"};function Fe(a){a=a||{};if(!a.window_features||-1!==navigator.userAgent.indexOf("Fennec/")||-1!==navigator.userAgent.indexOf("Firefox/")&&-1!==navigator.userAgent.indexOf("Android"))a.window_features=void 0;a.window_name||(a.window_name="_blank");a.relay_url||(a.relay_url=Be()+"/auth/channel");this.options=a}
Fe.prototype.open=function(a,b,c){function d(a){g&&(document.body.removeChild(g),g=void 0);q&&(q=clearInterval(q));ye(window,"message",e);ye(window,"unload",d);if(n&&!a)try{n.close()}catch(b){h.postMessage("die",l)}n=h=void 0}function e(a){if(a.origin===l)try{var b=ua(a.data);"ready"===b.a?h.postMessage(s,l):"error"===b.a?(d(!1),c&&(c(b.d),c=null)):"response"===b.a&&(d(b.df),c&&(c(null,b.d),c=null))}catch(e){}}var f=Ce(),g,h,l=ze(a);if(l!==ze(this.options.relay_url))c&&setTimeout(function(){c(Error("invalid arguments: origin of url and relay_url must match"))},
0);else{f&&(g=document.createElement("iframe"),g.setAttribute("src",this.options.relay_url),g.style.display="none",g.setAttribute("name","__winchan_relay_frame"),document.body.appendChild(g),h=g.contentWindow);a+=(/\?/.test(a)?"":"?")+Ae(b);var n=window.open(a,this.options.window_name,this.options.window_features);h||(h=n);var q=setInterval(function(){n&&n.closed&&(d(!1),c&&(c(V("USER_CANCELLED")),c=null))},500),s=u({a:"request",d:b});xe(window,"unload",d);xe(window,"message",e)}};
ma("fb.login.transports.Popup.prototype.open",Fe.prototype.open);Fe.isAvailable=function(){return!1};Fe.prototype.yb=function(){return"popup"};function Ge(a){a=a||{};a.callback_parameter||(a.callback_parameter="callback");this.options=a;window.__firebase_login_jsonp=window.__firebase_login_jsonp||{}}
Ge.prototype.open=function(a,b,c){function d(){c&&(c(V("REQUEST_INTERRUPTED")),c=null)}function e(){setTimeout(function(){delete window.__firebase_login_jsonp[f];Lc(window.__firebase_login_jsonp)&&delete window.__firebase_login_jsonp;try{var a=document.getElementById(f);a&&a.parentNode.removeChild(a)}catch(b){}},1);ye(window,"beforeunload",d)}var f="fn"+(new Date).getTime()+Math.floor(99999*Math.random());b[this.options.callback_parameter]="__firebase_login_jsonp."+f;a+=(/\?/.test(a)?"":"?")+Ae(b);
xe(window,"beforeunload",d);window.__firebase_login_jsonp[f]=function(a){c&&(c(null,a),c=null);e()};He(f,a,c)};
function He(a,b,c){setTimeout(function(){try{var d=document.createElement("script");d.type="text/javascript";d.id=a;d.async=!0;d.src=b;d.onerror=function(){var b=document.getElementById(a);null!==b&&b.parentNode.removeChild(b);c&&c(V("NETWORK_ERROR"))};var e=document.getElementsByTagName("head");(e&&0!=e.length?e[0]:document.documentElement).appendChild(d)}catch(f){c&&c(V("NETWORK_ERROR"))}},0)}Ge.isAvailable=function(){return!1};Ge.prototype.yb=function(){return"json"};function Ie(a,b){this.md=["session",a.wc,a.Pa].join(":");this.Fc=b}Ie.prototype.set=function(a,b){if(!b)if(this.Fc.length)b=this.Fc[0];else throw Error("fb.login.SessionManager : No storage options available!");b.set(this.md,a)};Ie.prototype.get=function(){var a=Gb(this.Fc,r(this.we,this)),a=Fb(a,function(a){return null!==a});Kb(a,function(a,c){return Md(c.token)-Md(a.token)});return 0<a.length?a.shift():null};Ie.prototype.we=function(a){try{var b=a.get(this.md);if(b&&b.token)return b}catch(c){}return null};
Ie.prototype.clear=function(){var a=this;Eb(this.Fc,function(b){b.remove(a.md)})};function Je(a){a=a||{};this.Vb=Cb()+Cb()+Cb();this.Qd=a||{}}Je.prototype.open=function(a,b){K.set("redirect_request_id",this.Vb);b.requestId=this.Vb;b.redirectTo=b.redirectTo||window.location.href;a+=(/\?/.test(a)?"":"?")+Ae(b);window.location=a};ma("fb.login.transports.Redirect.prototype.open",Je.prototype.open);Je.isAvailable=function(){return!1};Je.prototype.yb=function(){return"redirect"};function Ke(a,b,c,d){Gc.call(this,["auth_status"]);this.D=a;this.zd=b;this.Xe=c;this.fd=d;this.tb=new Ie(a,[wb,K]);this.Ia=null;Le(this)}na(Ke,Gc);k=Ke.prototype;k.Yc=function(){return this.Ia||null};function Le(a){K.get("redirect_request_id")&&Me(a);var b=a.tb.get();b&&b.token?(Ne(a,b),a.zd(b.token,function(c,d){Oe(a,c,d,!1,b.token,b)},function(b,d){Pe(a,"resumeSession()",b,d)})):Ne(a,null)}
function Qe(a,b,c,d,e,f){"firebaseio-demo.com"===a.D.domain&&M("FirebaseRef.auth() not supported on demo Firebases (*.firebaseio-demo.com). Please use on production Firebases only (*.firebaseio.com).");a.zd(b,function(f,h){Oe(a,f,h,!0,b,c,d||{},e)},function(b,c){Pe(a,"auth()",b,c,f)})}function Re(a,b){a.tb.clear();Ne(a,null);a.Xe(function(a,d){if("ok"===a)O(b);else{var e=(a||"error").toUpperCase(),f=e;d&&(f+=": "+d);f=Error(f);f.code=e;O(b,f)}})}
function Oe(a,b,c,d,e,f,g,h){"ok"===b?(d&&(b=c.auth,f.auth=b,f.expires=c.expires,f.token=Nd(e)?e:"",c=null,b&&A(b,"uid")?c=B(b,"uid"):A(f,"uid")&&(c=B(f,"uid")),f.uid=c,c="custom",b&&A(b,"provider")?c=B(b,"provider"):A(f,"provider")&&(c=B(f,"provider")),f.provider=c,a.tb.clear(),Nd(e)&&(g=g||{},c=wb,"sessionOnly"===g.remember&&(c=K),"none"!==g.remember&&a.tb.set(f,c)),Ne(a,f)),O(h,null,f)):(a.tb.clear(),Ne(a,null),f=a=(b||"error").toUpperCase(),c&&(f+=": "+c),f=Error(f),f.code=a,O(h,f))}
function Pe(a,b,c,d,e){M(b+" was canceled: "+d);a.tb.clear();Ne(a,null);a=Error(d);a.code=c.toUpperCase();O(e,a)}function Se(a,b,c,d){Te(a);var e=[De,Ge];c=ue(c);Ue(a,e,"/auth/"+b,c,d)}
function Ve(a,b,c,d){Te(a);var e=[Fe,Ee];c=ue(c);"anonymous"===b||"password"===b?setTimeout(function(){O(d,V("TRANSPORT_UNAVAILABLE"))},0):(c.Ic.window_features="menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=625,width=625,top="+("object"===typeof screen?.5*(screen.height-625):0)+",left="+("object"===typeof screen?.5*(screen.width-625):0),c.Ic.relay_url=Be()+"/"+a.D.Pa+"/auth/channel",c.Ic.requestWithCredential=r(a.Wb,a),Ue(a,e,"/auth/"+b,c,d))}
function Me(a){var b=K.get("redirect_request_id");if(b){var c=K.get("redirect_client_options");K.remove("redirect_request_id");K.remove("redirect_client_options");var d=[De,Ge],b=new se(c,{},{requestId:b});Ue(a,d,"/auth/session",b)}}k.Tc=function(a,b){Te(this);var c=ue(a);c.sb._method="POST";this.Wb("/users",c,function(a){O(b,a)})};
k.pd=function(a,b){var c=this;Te(this);var d="/users/"+encodeURIComponent(a.email),e=ue(a);e.sb._method="DELETE";this.Wb(d,e,function(a,d){!a&&d&&d.uid&&c.Ia&&c.Ia.uid&&c.Ia.uid===d.uid&&Re(c);O(b,a)})};k.Pc=function(a,b){Te(this);var c="/users/"+encodeURIComponent(a.email)+"/password",d=ue(a);d.sb._method="PUT";d.sb.password=a.newPassword;this.Wb(c,d,function(a){O(b,a)})};
k.qd=function(a,b){Te(this);var c="/users/"+encodeURIComponent(a.email)+"/password",d=ue(a);d.sb._method="POST";this.Wb(c,d,function(a){O(b,a)})};k.Wb=function(a,b,c){We(this,[De,Ge],a,b,c)};function Ue(a,b,c,d,e){We(a,b,c,d,function(b,c){!b&&c&&c.token&&c.uid?Qe(a,c.token,c,d.ec,function(a,b){a?O(e,a):O(e,null,b)}):O(e,b||V("UNKNOWN_ERROR"))})}
function We(a,b,c,d,e){b=Fb(b,function(a){return"function"===typeof a.isAvailable&&a.isAvailable()});0===b.length?setTimeout(function(){O(e,V("TRANSPORT_UNAVAILABLE"))},0):(b=new (b.shift())(d.Ic),d=Aa(d.sb),d.v="js-1.1.0",d.transport=b.yb(),d.suppress_status_codes=!0,a=Be()+"/"+a.D.Pa+c,b.open(a,d,function(a,b){if(a)O(e,a);else if(b&&b.error){var c=Error(b.error.message);c.code=b.error.code;c.details=b.error.details;O(e,c)}else O(e,null,b)}))}
function Ne(a,b){var c=null!==a.Ia||null!==b;a.Ia=b;c&&a.Jc("auth_status",b);a.fd(null!==b)}k.Zc=function(a){v("auth_status"===a,'initial event must be of type "auth_status"');return[this.Ia]};function Te(a){var b=a.D;if("firebaseio.com"!==b.domain&&"firebaseio-demo.com"!==b.domain&&"auth.firebase.com"===re)throw Error("This custom Firebase server ('"+a.D.domain+"') does not support delegated login.");};function Xe(){this.fb=[]}function Ye(a,b){if(0!==b.length)for(var c=0;c<b.length;c++)a.fb.push(b[c])}Xe.prototype.Sb=function(){for(var a=0;a<this.fb.length;a++)if(this.fb[a]){var b=this.fb[a];this.fb[a]=null;Ze(b)}this.fb=[]};function Ze(a){var b=a.ba,c=a.Zd,d=a.Rb;uc(function(){b(c,d)})};function W(a,b,c,d){this.type=a;this.wa=b;this.ca=c;this.Rb=d};function $e(a){this.S=a;this.ra=[];this.Vc=new Xe}function af(a,b,c,d,e){a.ra.push({type:b,ba:c,cancel:d,$:e});d=[];var f=bf(a.j);a.Eb&&f.push(new W("value",a.j));for(var g=0;g<f.length;g++)if(f[g].type===b){var h=new G(a.S.i,a.S.path);f[g].ca&&(h=h.J(f[g].ca));d.push({ba:qc(c,e),Zd:new S(f[g].wa,h),Rb:f[g].Rb})}Ye(a.Vc,d)}$e.prototype.yc=function(a,b){b=this.zc(a,b);null!=b&&cf(this,b)};
function cf(a,b){for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e.type,g=new G(a.S.i,a.S.path);b[d].ca&&(g=g.J(b[d].ca));g=new S(b[d].wa,g);"value"!==e.type||g.Db()?"value"!==e.type&&(f+=" "+g.name()):f+="("+g.X()+")";Zb(a.S.i.n.id+": event:"+a.S.path+":"+a.S.Ta()+":"+f);for(f=0;f<a.ra.length;f++){var h=a.ra[f];b[d].type===h.type&&c.push({ba:qc(h.ba,h.$),Zd:g,Rb:e.Rb})}}Ye(a.Vc,c)}$e.prototype.Sb=function(){this.Vc.Sb()};
function bf(a){var b=[];if(!a.Q()){var c=null;a.B(function(a,e){b.push(new W("child_added",e,a,c));c=a})}return b}function df(a){a.Eb||(a.Eb=!0,cf(a,[new W("value",a.j)]))};function ef(a,b){$e.call(this,a);this.j=b}na(ef,$e);ef.prototype.zc=function(a,b){this.j=a;this.Eb&&null!=b&&b.push(new W("value",this.j));return b};ef.prototype.Cb=function(){return{}};function ff(a,b){this.gc=a;this.gd=b}function gf(a,b,c,d,e){var f=a.N(c),g=b.N(c);d=new ff(d,e);e=hf(d,c,f,g);g=!f.f()&&!g.f()&&f.m()!==g.m();if(e||g)for(f=c,c=e;null!==f.parent();){var h=a.N(f);e=b.N(f);var l=f.parent();if(!d.gc||I(d.gc,l).k()){var n=b.N(l),q=[],f=Ua(f);h.f()?(h=n.ga(f,e),q.push(new W("child_added",e,f,h))):e.f()?q.push(new W("child_removed",h,f)):(h=n.ga(f,e),g&&q.push(new W("child_moved",e,f,h)),c&&q.push(new W("child_changed",e,f,h)));d.gd(l,n,q)}g&&(g=!1,c=!0);f=l}}
function hf(a,b,c,d){var e,f=[];c===d?e=!1:c.Q()&&d.Q()?e=c.k()!==d.k():c.Q()?(jf(a,b,P,d,f),e=!0):d.Q()?(jf(a,b,c,P,f),e=!0):e=jf(a,b,c,d,f);e?a.gd(b,d,f):c.m()!==d.m()&&a.gd(b,d,null);return e}
function jf(a,b,c,d,e){var f=!1,g=!a.gc||!I(a.gc,b).f(),h=[],l=[],n=[],q=[],s={},t={},w,$,J,N;w=c.hb();J=hb(w);$=d.hb();for(N=hb($);null!==J||null!==N;){c=N;c=null===J?1:null===c?-1:J.key===c.key?0:xc({name:J.key,ka:J.value.m()},{name:c.key,ka:c.value.m()});if(0>c)f=B(s,J.key),m(f)?(n.push({Xc:J,wd:h[f]}),h[f]=null):(t[J.key]=l.length,l.push(J)),f=!0,J=hb(w);else{if(0<c)f=B(t,N.key),m(f)?(n.push({Xc:l[f],wd:N}),l[f]=null):(s[N.key]=h.length,h.push(N)),f=!0;else{c=b.J(N.key);if(c=hf(a,c,J.value,N.value))q.push(N),
f=!0;J.value.m()!==N.value.m()&&(n.push({Xc:J,wd:N}),f=!0);J=hb(w)}N=hb($)}if(!g&&f)return!0}for(g=0;g<l.length;g++)if(s=l[g])c=b.J(s.key),hf(a,c,s.value,P),e.push(new W("child_removed",s.value,s.key));for(g=0;g<h.length;g++)if(s=h[g])c=b.J(s.key),l=d.ga(s.key,s.value),hf(a,c,P,s.value),e.push(new W("child_added",s.value,s.key,l));for(g=0;g<n.length;g++)s=n[g].Xc,h=n[g].wd,c=b.J(h.key),l=d.ga(h.key,h.value),e.push(new W("child_moved",h.value,h.key,l)),(c=hf(a,c,s.value,h.value))&&q.push(h);for(g=
0;g<q.length;g++)a=q[g],l=d.ga(a.key,a.value),e.push(new W("child_changed",a.value,a.key,l));return f};function kf(){this.Z=this.za=null;this.set={}}na(kf,fd);k=kf.prototype;k.setActive=function(a){this.za=a};function lf(a,b,c){a.add(b,c);a.Z||(a.Z=c.S.path)}function mf(a){var b=a.za;a.za=null;return b}function nf(a){return a.contains("default")}function of(a){return null!=a.za&&nf(a)}k.defaultView=function(){return nf(this)?this.get("default"):null};k.path=function(){return this.Z};k.toString=function(){return Gb(this.keys(),function(a){return"default"===a?"{}":a}).join("$")};
k.ob=function(){var a=[];gd(this,function(b,c){a.push(c.S)});return a};function pf(a,b){$e.call(this,a);this.j=P;this.zc(b,bf(b))}na(pf,$e);
pf.prototype.zc=function(a,b){if(null===b)return b;var c=[],d=this.S;m(d.ea)&&(m(d.ya)&&null!=d.ya?c.push(function(a,b){var c=jc(b,d.ea);return 0<c||0===c&&0<=kc(a,d.ya)}):c.push(function(a,b){return 0<=jc(b,d.ea)}));m(d.Ba)&&(m(d.bb)?c.push(function(a,b){var c=jc(b,d.Ba);return 0>c||0===c&&0>=kc(a,d.bb)}):c.push(function(a,b){return 0>=jc(b,d.Ba)}));var e=null,f=null;if(m(this.S.Da))if(m(this.S.ea)){if(e=qf(a,c,this.S.Da,!1)){var g=a.P(e).m();c.push(function(a,b){var c=jc(b,g);return 0>c||0===c&&
0>=kc(a,e)})}}else if(f=qf(a,c,this.S.Da,!0)){var h=a.P(f).m();c.push(function(a,b){var c=jc(b,h);return 0<c||0===c&&0<=kc(a,f)})}for(var l=[],n=[],q=[],s=[],t=0;t<b.length;t++){var w=b[t].ca,$=b[t].wa;switch(b[t].type){case "child_added":rf(c,w,$)&&(this.j=this.j.K(w,$),n.push(b[t]));break;case "child_removed":this.j.P(w).f()||(this.j=this.j.K(w,null),l.push(b[t]));break;case "child_changed":!this.j.P(w).f()&&rf(c,w,$)&&(this.j=this.j.K(w,$),s.push(b[t]));break;case "child_moved":var J=!this.j.P(w).f(),
N=rf(c,w,$);J?N?(this.j=this.j.K(w,$),q.push(b[t])):(l.push(new W("child_removed",this.j.P(w),w)),this.j=this.j.K(w,null)):N&&(this.j=this.j.K(w,$),n.push(b[t]))}}var Bd=e||f;if(Bd){var Cd=(t=null!==f)?this.j.Gd():this.j.Hd(),Oc=!1,ub=!1,vb=this;(t?a.Wc:a.B).call(a,function(a,b){ub||null!==Cd||(ub=!0);if(ub&&Oc)return!0;Oc?(l.push(new W("child_removed",vb.j.P(a),a)),vb.j=vb.j.K(a,null)):ub&&(n.push(new W("child_added",b,a)),vb.j=vb.j.K(a,b));Cd===a&&(ub=!0);a===Bd&&(Oc=!0)})}for(t=0;t<n.length;t++)c=
n[t],w=this.j.ga(c.ca,c.wa),l.push(new W("child_added",c.wa,c.ca,w));for(t=0;t<q.length;t++)c=q[t],w=this.j.ga(c.ca,c.wa),l.push(new W("child_moved",c.wa,c.ca,w));for(t=0;t<s.length;t++)c=s[t],w=this.j.ga(c.ca,c.wa),l.push(new W("child_changed",c.wa,c.ca,w));this.Eb&&0<l.length&&l.push(new W("value",this.j));return l};function qf(a,b,c,d){if(a.Q())return null;var e=null;(d?a.Wc:a.B).call(a,function(a,d){if(rf(b,a,d)&&(e=a,c--,0===c))return!0});return e}
function rf(a,b,c){for(var d=0;d<a.length;d++)if(!a[d](b,c.m()))return!1;return!0}pf.prototype.ad=function(a){return this.j.P(a)!==P};
pf.prototype.Cb=function(a,b,c){var d={};this.j.Q()||this.j.B(function(a){d[a]=3});var e=this.j;c=T(c,new H(""));var f=new Xa;Ya(I(f,this.S.path),!0);b=P.Aa(a,b);var g=this;gf(c,b,a,f,function(a,b,c){null!==c&&a.toString()===g.S.path.toString()&&g.zc(b,c)});this.j.Q()?pc(d,function(a,b){d[b]=2}):(this.j.B(function(a){A(d,a)||(d[a]=1)}),pc(d,function(a,b){g.j.P(b).f()&&(d[b]=2)}));this.j=e;return d};function sf(a,b){this.n=a;this.g=b;this.pc=b.aa;this.oa=new Xa}sf.prototype.bc=function(a,b,c,d,e){var f=a.path,g=I(this.oa,f),h=g.k();null===h?(h=new kf,Ya(g,h)):v(!h.f(),"We shouldn't be storing empty QueryMaps");var l=a.Ta();if(h.contains(l))a=h.get(l),af(a,b,c,d,e);else{var n=this.g.aa.N(f);a=tf(a,n);uf(this,g,h,l,a);af(a,b,c,d,e);(b=(b=ab(I(this.oa,f),function(a){var b;if(b=a.k()&&a.k().defaultView())b=a.k().defaultView().Eb;if(b)return!0},!0))||null===this.n&&!T(this.g,f).f())&&df(a)}a.Sb()};
function vf(a,b,c,d,e){var f=a.get(b),g;if(g=f){g=!1;for(var h=f.ra.length-1;0<=h;h--){var l=f.ra[h];if(!(c&&l.type!==c||d&&l.ba!==d||e&&l.$!==e)&&(f.ra.splice(h,1),g=!0,c&&d))break}}(c=g&&!(0<f.ra.length))&&a.remove(b);return c}function wf(a,b,c,d,e){b=b?b.Ta():null;var f=[];b&&"default"!==b?vf(a,b,c,d,e)&&f.push(b):Eb(a.keys(),function(b){vf(a,b,c,d,e)&&f.push(b)});return f}sf.prototype.Bc=function(a,b,c,d){var e=I(this.oa,a.path).k();return null===e?null:xf(this,e,a,b,c,d)};
function xf(a,b,c,d,e,f){var g=b.path(),g=I(a.oa,g);c=wf(b,c,d,e,f);b.f()&&Ya(g,null);d=yf(g);if(0<c.length&&!d){d=g;e=g.parent();for(c=!1;!c&&e;){if(f=e.k()){v(!of(f));var h=d.name(),l=!1;gd(f,function(a,b){l=b.ad(h)||l});l&&(c=!0)}d=e;e=e.parent()}d=null;of(b)||(b=mf(b),d=zf(a,g),b&&b());return c?null:d}return null}function Af(a,b,c){$a(I(a.oa,b),function(a){(a=a.k())&&gd(a,function(a,b){df(b)})},c,!0)}
function Bf(a,b,c){function d(a){do{if(g[a.toString()])return!0;a=a.parent()}while(null!==a);return!1}var e=a.pc,f=a.g.aa;a.pc=f;for(var g={},h=0;h<c.length;h++)g[c[h].toString()]=!0;gf(e,f,b,a.oa,function(c,e,f){if(b.contains(c)){var g=d(c);g&&Af(a,c,!1);a.yc(c,e,f);g&&Af(a,c,!0)}else a.yc(c,e,f)});d(b)&&Af(a,b,!0);Cf(a,b)}function Cf(a,b){var c=I(a.oa,b);$a(c,function(a){(a=a.k())&&gd(a,function(a,b){b.Sb()})},!0,!0);ab(c,function(a){(a=a.k())&&gd(a,function(a,b){b.Sb()})},!1)}
sf.prototype.yc=function(a,b,c){a=I(this.oa,a).k();null!==a&&gd(a,function(a,e){e.yc(b,c)})};function yf(a){return ab(a,function(a){return a.k()&&of(a.k())})}function uf(a,b,c,d,e){if(of(c)||yf(b))lf(c,d,e);else{var f,g;c.f()||(f=c.toString(),g=c.ob());lf(c,d,e);c.setActive(Df(a,c));f&&g&&Wd(a.n,c.path(),f,g)}of(c)&&$a(b,function(a){if(a=a.k())a.za&&a.za(),a.za=null})}
function zf(a,b){function c(b){var f=b.k();if(f&&nf(f))d.push(f.path()),null==f.za&&f.setActive(Df(a,f));else{if(f){null!=f.za||f.setActive(Df(a,f));var g={};gd(f,function(a,b){b.j.B(function(a){A(g,a)||(g[a]=!0,a=f.path().J(a),d.push(a))})})}b.B(c)}}var d=[];c(b);return d}
function Df(a,b){if(a.n){var c=a.n,d=b.path(),e=b.toString(),f=b.ob(),g,h=b.keys(),l=nf(b);Sd(a.n,b,function(c){"ok"!==c?(c=sc(c),M("on() or once() for "+b.path().toString()+" failed: "+c.toString()),Ef(a,b,c)):g||(l?Af(a,b.path(),!0):Eb(h,function(a){(a=b.get(a))&&df(a)}),Cf(a,b.path()))});return function(){g=!0;Wd(c,d,e,f)}}return ba}function Ef(a,b,c){b&&(gd(b,function(a,b){for(var f=0;f<b.ra.length;f++){var g=b.ra[f];g.cancel&&qc(g.cancel,g.$)(c)}}),xf(a,b))}
function tf(a,b){return"default"===a.Ta()?new ef(a,b):new pf(a,b)}sf.prototype.Cb=function(a,b,c,d){function e(a){pc(a,function(a,b){f[b]=3===a?3:(B(f,b)||a)===a?a:3})}var f={};gd(b,function(b,f){e(f.Cb(a,c,d))});c.Q()||c.B(function(a){A(f,a)||(f[a]=4)});return f};function Ff(a,b,c,d,e){var f=b.path();b=a.Cb(f,b,d,e);var g=P,h=[];pc(b,function(b,n){var q=new H(n);3===b||1===b?g=g.K(n,d.N(q)):(2===b&&h.push({path:f.J(n),ta:P}),h=h.concat(Gf(a,d.N(q),I(c,q),e)))});return[{path:f,ta:g}].concat(h)}
function Hf(a,b,c,d){var e;a:{var f=I(a.oa,b);e=f.parent();for(var g=[];null!==e;){var h=e.k();if(null!==h){if(nf(h)){e=[{path:b,ta:c}];break a}h=a.Cb(b,h,c,d);f=B(h,f.name());if(3===f||1===f){e=[{path:b,ta:c}];break a}2===f&&g.push({path:b,ta:P})}f=e;e=e.parent()}e=g}if(1==e.length&&(!e[0].ta.f()||c.f()))return e;g=I(a.oa,b);f=g.k();null!==f?nf(f)?e.push({path:b,ta:c}):e=e.concat(Ff(a,f,g,c,d)):e=e.concat(Gf(a,c,g,d));return e}
function Gf(a,b,c,d){var e=c.k();if(null!==e)return nf(e)?[{path:c.path(),ta:b}]:Ff(a,e,c,b,d);var f=[];c.B(function(c){var e=b.Q()?P:b.P(c.name());c=Gf(a,e,c,d);f=f.concat(c)});return f};function If(a){this.D=a;this.fa=Wc(a);this.n=new Od(this.D,r(this.sc,this),r(this.qc,this),r(this.kd,this),r(this.$c,this));this.ae=Xc(a,r(function(){return new Tc(this.fa,this.n)},this));this.Xa=new Xa;this.Ga=new ie;this.g=new je;this.L=new sf(this.n,this.g.pa);this.bd=new ie;this.cd=new sf(null,this.bd);Jf(this,"connected",!1);this.U=new fe;this.I=new Ke(a,r(this.n.I,this.n),r(this.n.yd,this.n),r(this.fd,this));this.fc=0}k=If.prototype;
k.toString=function(){return(this.D.Va?"https://":"http://")+this.D.host};k.name=function(){return this.D.Pa};function Kf(a){a=T(a.bd,new H(".info/serverTimeOffset")).X()||0;return(new Date).getTime()+a}function Lf(a){a=a={timestamp:Kf(a)};a.timestamp=a.timestamp||(new Date).getTime();return a}
k.sc=function(a,b,c){this.fc++;this.Jd&&(b=this.Jd(a,b));var d,e,f=[];9<=a.length&&a.lastIndexOf(".priority")===a.length-9?(d=new H(a.substring(0,a.length-9)),e=T(this.g.va,d).Ha(b),f.push(d)):c?(d=new H(a),e=T(this.g.va,d),pc(b,function(a,b){var c=new H(b);".priority"===b?e=e.Ha(a):(e=e.Aa(c,R(a)),f.push(d.J(b)))})):(d=new H(a),e=R(b),f.push(d));a=Hf(this.L,d,e,this.g.O);b=!1;for(c=0;c<a.length;++c){var g=a[c];b=ke(this.g,g.path,g.ta)||b}b&&(d=Mf(this,d));Bf(this.L,d,f)};
k.qc=function(a){Jf(this,"connected",a);!1===a&&Nf(this)};k.kd=function(a){var b=this;oc(a,function(a,d){Jf(b,d,a)})};k.$c=function(a){a=new H(a);return T(this.g.va,a).hash()};k.fd=function(a){Jf(this,"authenticated",a)};function Jf(a,b,c){b=new H("/.info/"+b);U(a.bd,b,R(c));Bf(a.cd,b,[b])}
k.ub=function(a,b,c,d){this.e("set",{path:a.toString(),value:b,ka:c});var e=Lf(this);b=R(b,c);var e=qe(b,e),e=Hf(this.L,a,e,this.g.O),f=this.g.set(a,e),g=this;this.n.put(a.toString(),b.X(!0),function(b,c){"ok"!==b&&M("set at "+a+" failed: "+b);ne(g.g,f);le(g.g,a);var e=Mf(g,a);Bf(g.L,e,[]);Of(d,b,c)});e=Pf(this,a);Mf(this,e);Bf(this.L,e,[a])};
k.update=function(a,b,c){this.e("update",{path:a.toString(),value:b});var d=T(this.g.pa,a),e=!0,f=[],g=Lf(this),h=[],l;for(l in b){var e=!1,n=R(b[l]),n=qe(n,g),d=d.K(l,n),q=a.J(l);f.push(q);n=Hf(this.L,q,n,this.g.O);h=h.concat(this.g.set(a,n))}if(e)Zb("update() called with empty data.  Don't do anything."),Of(c,"ok");else{var s=this;be(this.n,a.toString(),b,function(b,d){"ok"!==b&&M("update at "+a+" failed: "+b);ne(s.g,h);le(s.g,a);var e=Mf(s,a);Bf(s.L,e,[]);Of(c,b,d)});b=Pf(this,a);Mf(this,b);Bf(s.L,
b,f)}};k.sd=function(a,b,c){this.e("setPriority",{path:a.toString(),ka:b});var d=Lf(this),d=oe(b,d),d=T(this.g.O,a).Ha(d),d=Hf(this.L,a,d,this.g.O),e=this.g.set(a,d),f=this;this.n.put(a.toString()+"/.priority",b,function(b,d){"permission_denied"===b&&M("setPriority at "+a+" failed: "+b);ne(f.g,e);le(f.g,a);var l=Mf(f,a);Bf(f.L,l,[]);Of(c,b,d)});b=Mf(this,a);Bf(f.L,b,[])};
function Nf(a){a.e("onDisconnectEvents");var b=[],c=Lf(a);he(pe(a.U,c),new H(""),function(c,e){var f=Hf(a.L,c,e,a.g.O);b.push.apply(b,a.g.set(c,f));f=Pf(a,c);Mf(a,f);Bf(a.L,f,[c])});ne(a.g,b);a.U=new fe}k.hd=function(a,b){var c=this;this.n.hd(a.toString(),function(d,e){"ok"===d&&ge(c.U,a);Of(b,d,e)})};function Qf(a,b,c,d){var e=R(c);Yd(a.n,b.toString(),e.X(!0),function(c,g){"ok"===c&&a.U.pb(b,e);Of(d,c,g)})}
function Rf(a,b,c,d,e){var f=R(c,d);Yd(a.n,b.toString(),f.X(!0),function(c,d){"ok"===c&&a.U.pb(b,f);Of(e,c,d)})}function Sf(a,b,c,d){var e=!0,f;for(f in c)e=!1;e?(Zb("onDisconnect().update() called with empty data.  Don't do anything."),Of(d,"ok")):$d(a.n,b.toString(),c,function(e,f){if("ok"===e)for(var l in c){var n=R(c[l]);a.U.pb(b.J(l),n)}Of(d,e,f)})}function Tf(a){Rc(a.fa,"deprecated_on_disconnect");a.ae.vd.deprecated_on_disconnect=!0}
...
k.Ma=function(){this.n.Ma()};k.rb=function(){this.n.rb()};k.td=function(a){if("undefined"!==typeof console){a?(this.Ec||(this.Ec=new Sc(this.fa)),a=this.Ec.get()):a=this.fa.get();var b=Hb(Kc(a),function(a,b){return Math.max(b.length,a)},0),c;for(c in a){for(var d=a[c],e=c.length;e<b+2;e++)c+=" ";console.log(c+d)}}};k.ud=function(a){Rc(this.fa,a);this.ae.vd[a]=!0};k.e=function(){Zb("r:"+this.n.id+":",arguments)};
function Of(a,b,c){a&&uc(function(){if("ok"==b)a(null,c);else{var d=(b||"error").toUpperCase(),e=d;c&&(e+=": "+c);e=Error(e);e.code=d;a(e)}})};function Uf(a,b,c,d,e){function f(){}a.e("transaction on "+b);var g=new G(a,b);g.Qa("value",f);c={path:b,update:c,G:d,status:null,Rd:Xb(),Nc:e,Vd:0,Kc:function(){g.kb("value",f)},Lc:null};a.Ga.aa=Vf(a,a.Ga.aa,a.g.O.aa,a.Xa);d=c.update(T(a.Ga,b).X());if(m(d)){Fa("transaction failed: Data returned ",d);c.status=1;e=I(a.Xa,b);var h=e.k()||[];h.push(c);Ya(e,h);h="object"===typeof d&&null!==d&&A(d,".priority")?d[".priority"]:T(a.g.O,b).m();e=Lf(a);d=R(d,h);d=qe(d,e);U(a.Ga,b,d);c.Nc&&(U(a.g.pa,b,d),Bf(a.L,
b,[b]));Wf(a)}else c.Kc(),c.G&&(a=Xf(a,b),c.G(null,!1,a))}function Wf(a,b){var c=b||a.Xa;b||Yf(a,c);if(null!==c.k()){var d=Zf(a,c);v(0<d.length);Ib(d,function(a){return 1===a.status})&&$f(a,c.path(),d)}else c.Db()&&c.B(function(b){Wf(a,b)})}
function $f(a,b,c){for(var d=0;d<c.length;d++)v(1===c[d].status,"tryToSendTransactionQueue_: items in queue should all be run."),c[d].status=2,c[d].Vd++;var e=T(a.g.O,b).hash();U(a.g.O,b,T(a.g.pa,b));for(var f=T(a.Ga,b).X(!0),g=Xb(),h=ag(c),d=0;d<h.length;d++)Ya(I(a.g.Pb,h[d]),g);a.n.put(b.toString(),f,function(e){a.e("transaction put response",{path:b.toString(),status:e});for(d=0;d<h.length;d++){var f=I(a.g.Pb,h[d]),q=f.k();v(null!==q,"sendTransactionQueue_: pendingPut should not be null.");q===
g&&(Ya(f,null),U(a.g.O,h[d],T(a.g.va,h[d])))}if("ok"===e){e=[];for(d=0;d<c.length;d++)c[d].status=3,c[d].G&&(f=Xf(a,c[d].path),e.push(r(c[d].G,null,null,!0,f))),c[d].Kc();Yf(a,I(a.Xa,b));Wf(a);for(d=0;d<e.length;d++)uc(e[d])}else{if("datastale"===e)for(d=0;d<c.length;d++)c[d].status=4===c[d].status?5:1;else for(M("transaction at "+b+" failed: "+e),d=0;d<c.length;d++)c[d].status=5,c[d].Lc=e;e=Mf(a,b);Bf(a.L,e,[b])}},e)}
function ag(a){for(var b={},c=0;c<a.length;c++)a[c].Nc&&(b[a[c].path.toString()]=a[c].path);a=[];for(var d in b)a.push(b[d]);return a}
function Mf(a,b){var c=bg(a,b),d=c.path(),c=Zf(a,c);U(a.g.pa,d,T(a.g.O,d));U(a.Ga,d,T(a.g.O,d));if(0!==c.length){for(var e=T(a.g.pa,d),f=e,g=[],h=0;h<c.length;h++){var l=Va(d,c[h].path),n=!1,q;v(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null.");if(5===c[h].status)n=!0,q=c[h].Lc;else if(1===c[h].status)if(25<=c[h].Vd)n=!0,q="maxretry";else{var s=e.N(l),t=c[h].update(s.X());if(m(t)){Fa("transaction failed: Data returned ",t);var w=R(t);"object"===typeof t&&null!=t&&A(t,".priority")||
(w=w.Ha(s.m()));e=e.Aa(l,w);c[h].Nc&&(f=f.Aa(l,w))}else n=!0,q="nodata"}n&&(c[h].status=3,setTimeout(c[h].Kc,Math.floor(0)),c[h].G&&(n=new G(a,c[h].path),l=new S(e.N(l),n),"nodata"===q?g.push(r(c[h].G,null,null,!1,l)):g.push(r(c[h].G,null,Error(q),!1,l))))}U(a.Ga,d,e);U(a.g.pa,d,f);Yf(a,a.Xa);for(h=0;h<g.length;h++)uc(g[h]);Wf(a)}return d}function bg(a,b){for(var c,d=a.Xa;null!==(c=D(b))&&null===d.k();)d=I(d,c),b=Ta(b);return d}
function Zf(a,b){var c=[];cg(a,b,c);c.sort(function(a,b){return a.Rd-b.Rd});return c}function cg(a,b,c){var d=b.k();if(null!==d)for(var e=0;e<d.length;e++)c.push(d[e]);b.B(function(b){cg(a,b,c)})}function Yf(a,b){var c=b.k();if(c){for(var d=0,e=0;e<c.length;e++)3!==c[e].status&&(c[d]=c[e],d++);c.length=d;Ya(b,0<c.length?c:null)}b.B(function(b){Yf(a,b)})}function Pf(a,b){var c=bg(a,b).path(),d=I(a.Xa,b);ab(d,function(a){dg(a)});dg(d);$a(d,function(a){dg(a)});return c}
function dg(a){var b=a.k();if(null!==b){for(var c=[],d=-1,e=0;e<b.length;e++)4!==b[e].status&&(2===b[e].status?(v(d===e-1,"All SENT items should be at beginning of queue."),d=e,b[e].status=4,b[e].Lc="set"):(v(1===b[e].status),b[e].Kc(),b[e].G&&c.push(r(b[e].G,null,Error("set"),!1,null))));-1===d?Ya(a,null):b.length=d+1;for(e=0;e<c.length;e++)uc(c[e])}}function Xf(a,b){var c=new G(a,b);return new S(T(a.Ga,b),c)}
function Vf(a,b,c,d){if(d.f())return c;if(null!=d.k())return b;var e=c;d.B(function(d){var g=d.name(),h=new H(g);d=Vf(a,b.N(h),c.N(h),d);e=e.K(g,d)});return e};function X(){this.qb={}}ca(X);X.prototype.Ma=function(){for(var a in this.qb)this.qb[a].Ma()};X.prototype.interrupt=X.prototype.Ma;X.prototype.rb=function(){for(var a in this.qb)this.qb[a].rb()};X.prototype.resume=X.prototype.rb;function eg(a){var b=this;this.xb=a;this.Gc="*";Ce()?this.Ib=this.ic=we():(this.Ib=window.opener,this.ic=window);if(!b.Ib)throw"Unable to find relay frame";xe(this.ic,"message",r(this.lb,this));xe(this.ic,"message",r(this.Od,this));try{fg(this,{a:"ready"})}catch(c){xe(this.Ib,"load",function(){fg(b,{a:"ready"})})}xe(window,"unload",r(this.He,this))}function fg(a,b){b=u(b);Ce()?a.Ib.doPost(b,a.Gc):a.Ib.postMessage(b,a.Gc)}
eg.prototype.lb=function(a){var b=this,c;try{c=ua(a.data)}catch(d){}c&&"request"===c.a&&(ye(window,"message",this.lb),this.Gc=a.origin,this.xb&&setTimeout(function(){b.xb(b.Gc,c.d,function(a,c){b.ne=!c;b.xb=void 0;fg(b,{a:"response",d:a,forceKeepWindowOpen:c})})},0))};eg.prototype.He=function(){try{ye(this.ic,"message",this.Od)}catch(a){}this.xb&&(fg(this,{a:"error",d:"unknown closed window"}),this.xb=void 0);try{window.close()}catch(b){}};eg.prototype.Od=function(a){if(this.ne&&"die"===a.data)try{window.close()}catch(b){}};var Y={xe:function(a){var b=Q.prototype.hash;Q.prototype.hash=a;var c=vc.prototype.hash;vc.prototype.hash=a;return function(){Q.prototype.hash=b;vc.prototype.hash=c}}};Y.hijackHash=Y.xe;Y.Ta=function(a){return a.Ta()};Y.queryIdentifier=Y.Ta;Y.Ae=function(a){return a.i.n.ia};Y.listens=Y.Ae;Y.Me=function(a){return a.i.n.la};Y.refConnection=Y.Me;Y.de=Od;Y.DataConnection=Y.de;Od.prototype.sendRequest=Od.prototype.Fa;Od.prototype.interrupt=Od.prototype.Ma;Y.ee=xd;Y.RealTimeConnection=Y.ee;
xd.prototype.sendRequest=xd.prototype.Yd;xd.prototype.close=xd.prototype.close;Y.ce=xb;Y.ConnectionTarget=Y.ce;Y.ue=function(){id=$c=!0};Y.forceLongPolling=Y.ue;Y.ve=function(){jd=!0};Y.forceWebSockets=Y.ve;Y.Te=function(a,b){a.i.n.rd=b};Y.setSecurityDebugCallback=Y.Te;Y.td=function(a,b){a.i.td(b)};Y.stats=Y.td;Y.ud=function(a,b){a.i.ud(b)};Y.statsIncrementCounter=Y.ud;Y.fc=function(a){return a.i.fc};Y.dataUpdateCount=Y.fc;Y.ye=function(a,b){a.i.Jd=b};Y.interceptServerData=Y.ye;Y.De=function(a){new eg(a)};
Y.onPopupOpen=Y.De;Y.Qe=function(a){re=a};Y.setAuthenticationServer=Y.Qe;function Z(a,b,c){this.Tb=a;this.Z=b;this.Ea=c}Z.prototype.cancel=function(a){x("Firebase.onDisconnect().cancel",0,1,arguments.length);z("Firebase.onDisconnect().cancel",1,a,!0);this.Tb.hd(this.Z,a)};Z.prototype.cancel=Z.prototype.cancel;Z.prototype.remove=function(a){x("Firebase.onDisconnect().remove",0,1,arguments.length);C("Firebase.onDisconnect().remove",this.Z);z("Firebase.onDisconnect().remove",1,a,!0);Qf(this.Tb,this.Z,null,a)};Z.prototype.remove=Z.prototype.remove;
Z.prototype.set=function(a,b){x("Firebase.onDisconnect().set",1,2,arguments.length);C("Firebase.onDisconnect().set",this.Z);Ea("Firebase.onDisconnect().set",a,!1);z("Firebase.onDisconnect().set",2,b,!0);Qf(this.Tb,this.Z,a,b)};Z.prototype.set=Z.prototype.set;
Z.prototype.ub=function(a,b,c){x("Firebase.onDisconnect().setWithPriority",2,3,arguments.length);C("Firebase.onDisconnect().setWithPriority",this.Z);Ea("Firebase.onDisconnect().setWithPriority",a,!1);Ja("Firebase.onDisconnect().setWithPriority",2,b,!1);z("Firebase.onDisconnect().setWithPriority",3,c,!0);if(".length"===this.Ea||".keys"===this.Ea)throw"Firebase.onDisconnect().setWithPriority failed: "+this.Ea+" is a read-only object.";Rf(this.Tb,this.Z,a,b,c)};Z.prototype.setWithPriority=Z.prototype.ub;
Z.prototype.update=function(a,b){x("Firebase.onDisconnect().update",1,2,arguments.length);C("Firebase.onDisconnect().update",this.Z);if(ea(a)){for(var c={},d=0;d<a.length;++d)c[""+d]=a[d];a=c;M("Passing an Array to Firebase.onDisconnect().update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}Ia("Firebase.onDisconnect().update",a);z("Firebase.onDisconnect().update",2,b,!0);Sf(this.Tb,
this.Z,a,b)};Z.prototype.update=Z.prototype.update;var gg=function(){var a=0,b=[];return function(c){var d=c===a;a=c;for(var e=Array(8),f=7;0<=f;f--)e[f]="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(c%64),c=Math.floor(c/64);v(0===c,"Cannot push at time == 0");c=e.join("");if(d){for(f=11;0<=f&&63===b[f];f--)b[f]=0;b[f]++}else for(f=0;12>f;f++)b[f]=Math.floor(64*Math.random());for(f=0;12>f;f++)c+="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(b[f]);v(20===c.length,"NextPushId: Length should be 20.");
return c}}();function G(a,b){var c,d,e;if(a instanceof If)c=a,d=b;else{x("new Firebase",1,2,arguments.length);d=hc(arguments[0]);c=d.Ve;"firebase"===d.domain&&gc(d.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead");c||gc("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com");d.Va||"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&M("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");
c=new xb(d.host,d.Va,c,"ws"===d.scheme||"wss"===d.scheme);d=new H(d.mb);e=d.toString();var f;!(f=!p(c.host)||0===c.host.length||!Da(c.Pa))&&(f=0!==e.length)&&(e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),f=!(p(e)&&0!==e.length&&!Ca.test(e)));if(f)throw Error(y("new Firebase",1,!1)+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');if(b)if(b instanceof X)e=b;else if(p(b))e=X.gb(),c.wc=b;else throw Error("Expected a valid Firebase.Context for second argument to new Firebase()");
else e=X.gb();f=c.toString();var g=B(e.qb,f);g||(g=new If(c),e.qb[f]=g);c=g}F.call(this,c,d)}na(G,F);ma("Firebase",G);module.exports=G;G.prototype.name=function(){x("Firebase.name",0,0,arguments.length);return this.path.f()?null:Ua(this.path)};G.prototype.name=G.prototype.name;
...
G.prototype.set=function(a,b){x("Firebase.set",1,2,arguments.length);C("Firebase.set",this.path);Ea("Firebase.set",a,!1);z("Firebase.set",2,b,!0);this.i.ub(this.path,a,null,b)};G.prototype.set=G.prototype.set;
...
this.i.update(this.path,a,b)};G.prototype.update=G.prototype.update;G.prototype.ub=function(a,b,c){x("Firebase.setWithPriority",2,3,arguments.length);C("Firebase.setWithPriority",this.path);Ea("Firebase.setWithPriority",a,!1);Ja("Firebase.setWithPriority",2,b,!1);z("Firebase.setWithPriority",3,c,!0);if(".length"===this.name()||".keys"===this.name())throw"Firebase.setWithPriority failed: "+this.name()+" is a read-only object.";this.i.ub(this.path,a,b,c)};G.prototype.setWithPriority=G.prototype.ub;
...
G.prototype.transaction=function(a,b,c){x("Firebase.transaction",1,3,arguments.length);C("Firebase.transaction",this.path);z("Firebase.transaction",1,a,!1);z("Firebase.transaction",2,b,!0);if(m(c)&&"boolean"!=typeof c)throw Error(y("Firebase.transaction",3,!0)+"must be a boolean.");if(".length"===this.name()||".keys"===this.name())throw"Firebase.transaction failed: "+this.name()+" is a read-only object.";"undefined"===typeof c&&(c=!0);Uf(this.i,this.path,a,b,c)};G.prototype.transaction=G.prototype.transaction;
G.prototype.sd=function(a,b){x("Firebase.setPriority",1,2,arguments.length);C("Firebase.setPriority",this.path);Ja("Firebase.setPriority",1,a,!1);z("Firebase.setPriority",2,b,!0);this.i.sd(this.path,a,b)};G.prototype.setPriority=G.prototype.sd;G.prototype.push=function(a,b){x("Firebase.push",0,2,arguments.length);C("Firebase.push",this.path);Ea("Firebase.push",a,!0);z("Firebase.push",2,b,!0);var c=Kf(this.i),c=gg(c),c=this.J(c);"undefined"!==typeof a&&null!==a&&c.set(a,b);return c};
G.prototype.push=G.prototype.push;G.prototype.ja=function(){return new Z(this.i,this.path,this.name())};G.prototype.onDisconnect=G.prototype.ja;G.prototype.Ne=function(){M("FirebaseRef.removeOnDisconnect() being deprecated. Please use FirebaseRef.onDisconnect().remove() instead.");this.ja().remove();Tf(this.i)};G.prototype.removeOnDisconnect=G.prototype.Ne;
G.prototype.Se=function(a){M("FirebaseRef.setOnDisconnect(value) being deprecated. Please use FirebaseRef.onDisconnect().set(value) instead.");this.ja().set(a);Tf(this.i)};G.prototype.setOnDisconnect=G.prototype.Se;G.prototype.I=function(a,b,c){M("FirebaseRef.auth() being deprecated. Please use FirebaseRef.authWithCustomToken() instead.");x("Firebase.auth",1,3,arguments.length);Na("Firebase.auth",a);z("Firebase.auth",2,b,!0);z("Firebase.auth",3,b,!0);Qe(this.i.I,a,{},{remember:"none"},b,c)};
G.prototype.auth=G.prototype.I;G.prototype.yd=function(a){x("Firebase.unauth",0,1,arguments.length);z("Firebase.unauth",1,a,!0);Re(this.i.I,a)};G.prototype.unauth=G.prototype.yd;G.prototype.Yc=function(){x("Firebase.getAuth",0,0,arguments.length);return this.i.I.Yc()};G.prototype.getAuth=G.prototype.Yc;G.prototype.Ce=function(a,b){x("Firebase.onAuth",1,2,arguments.length);z("Firebase.onAuth",1,a,!1);ya("Firebase.onAuth",2,b);this.i.I.Qa("auth_status",a,b)};G.prototype.onAuth=G.prototype.Ce;
G.prototype.Be=function(a,b){x("Firebase.offAuth",1,2,arguments.length);z("Firebase.offAuth",1,a,!1);ya("Firebase.offAuth",2,b);this.i.I.kb("auth_status",a,b)};G.prototype.offAuth=G.prototype.Be;G.prototype.ie=function(a,b,c){x("Firebase.authWithCustomToken",2,3,arguments.length);Na("Firebase.authWithCustomToken",a);z("Firebase.authWithCustomToken",2,b,!1);E("Firebase.authWithCustomToken",3,c,!0);Qe(this.i.I,a,{},c||{},b)};G.prototype.authWithCustomToken=G.prototype.ie;
G.prototype.je=function(a,b,c){x("Firebase.authWithOAuthPopup",2,3,arguments.length);Oa("Firebase.authWithOAuthPopup",1,a);z("Firebase.authWithOAuthPopup",2,b,!1);E("Firebase.authWithOAuthPopup",3,c,!0);Ve(this.i.I,a,c,b)};G.prototype.authWithOAuthPopup=G.prototype.je;
G.prototype.ke=function(a,b,c){x("Firebase.authWithOAuthRedirect",2,3,arguments.length);Oa("Firebase.authWithOAuthRedirect",1,a);z("Firebase.authWithOAuthRedirect",2,b,!1);E("Firebase.authWithOAuthRedirect",3,c,!0);var d=this.i.I;Te(d);var e=[Je],f=ue(c);"anonymous"===a||"firebase"===a?O(b,V("TRANSPORT_UNAVAILABLE")):(K.set("redirect_client_options",f.ec),Ue(d,e,"/auth/"+a,f,b))};G.prototype.authWithOAuthRedirect=G.prototype.ke;
G.prototype.le=function(a,b,c,d){x("Firebase.authWithOAuthToken",3,4,arguments.length);Oa("Firebase.authWithOAuthToken",1,a);z("Firebase.authWithOAuthToken",3,c,!1);E("Firebase.authWithOAuthToken",4,d,!0);p(b)?(Oa("Firebase.authWithOAuthToken",2,b),Se(this.i.I,a+"/token",{access_token:b},c)):(E("Firebase.authWithOAuthToken",2,b,!1),Se(this.i.I,a+"/token",b,c))};G.prototype.authWithOAuthToken=G.prototype.le;
G.prototype.he=function(a,b){x("Firebase.authAnonymously",1,2,arguments.length);z("Firebase.authAnonymously",1,a,!1);E("Firebase.authAnonymously",2,b,!0);Se(this.i.I,"anonymous",{},a)};G.prototype.authAnonymously=G.prototype.he;
G.prototype.me=function(a,b,c){x("Firebase.authWithPassword",2,3,arguments.length);E("Firebase.authWithPassword",1,a,!1);Pa("Firebase.authWithPassword",a,"email");Pa("Firebase.authWithPassword",a,"password");z("Firebase.authAnonymously",2,b,!1);E("Firebase.authAnonymously",3,c,!0);Se(this.i.I,"password",a,b)};G.prototype.authWithPassword=G.prototype.me;
...
G.prototype.qd=function(a,b){x("Firebase.resetPassword",2,2,arguments.length);E("Firebase.resetPassword",1,a,!1);Pa("Firebase.resetPassword",a,"email");z("Firebase.resetPassword",2,b,!1);this.i.I.qd(a,b)};G.prototype.resetPassword=G.prototype.qd;G.goOffline=function(){x("Firebase.goOffline",0,0,arguments.length);X.gb().Ma()};G.goOnline=function(){x("Firebase.goOnline",0,0,arguments.length);X.gb().rb()};
